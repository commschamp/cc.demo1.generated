...
struct EnumsFields
{
    ...
    /// @see @ref demo1::message::EnumsFieldsCommon::F1Common::ValueType
    class F1 : public
        comms::field::EnumValue<
            demo1::field::FieldBase<>,
            demo1::message::EnumsFieldsCommon::F1Common::ValueType,
    ...
    public:
        ...
        using ValueNameInfo = demo1::message::EnumsFieldsCommon::F1Common::ValueNameInfo;
        
        /// @brief Type returned from @ref valueNamesMap() member function.
        /// @see @ref demo1::message::EnumsFieldsCommon::F1Common::ValueNamesMapInfo.
        using ValueNamesMapInfo = demo1::message::EnumsFieldsCommon::F1Common::ValueNamesMapInfo;
        
        /// @brief Retrieve name of the enum value.
        /// @see @ref demo1::message::EnumsFieldsCommon::F1Common::valueName().
        ...
        /// @see @ref demo1::message::EnumsFieldsCommon::F1Common::valueNamesMap().
        static ValueNamesMapInfo valueNamesMap()
        {
            return demo1::message::EnumsFieldsCommon::F1Common::valueNamesMap();
        }
    ...
    /// @see @ref demo1::message::EnumsFieldsCommon::F2Common::ValueType
    class F2 : public
        comms::field::EnumValue<
            demo1::field::FieldBase<>,
            demo1::message::EnumsFieldsCommon::F2Common::ValueType,
    ...
    public:
        ...
        /// @brief Single value name info entry.
        using ValueNameInfo = demo1::message::EnumsFieldsCommon::F2Common::ValueNameInfo;
        
        /// @brief Type returned from @ref valueNamesMap() member function.
        /// @see @ref demo1::message::EnumsFieldsCommon::F2Common::ValueNamesMapInfo.
        using ValueNamesMapInfo = demo1::message::EnumsFieldsCommon::F2Common::ValueNamesMapInfo;
        
        /// @brief Retrieve name of the enum value.
        /// @see @ref demo1::message::EnumsFieldsCommon::F2Common::valueName().
        static const char* valueName(ValueType val)
        {
        ...
        /// @brief Retrieve map of enum value names.
        /// @see @ref demo1::message::EnumsFieldsCommon::F2Common::valueNamesMap().
        static ValueNamesMapInfo valueNamesMap()
        {
            return demo1::message::EnumsFieldsCommon::F2Common::valueNamesMap();
        }
    ...
    /// @see @ref demo1::message::EnumsFieldsCommon::F3Common::ValueType
    class F3 : public
        comms::field::EnumValue<
            demo1::field::FieldBase<>,
            demo1::message::EnumsFieldsCommon::F3Common::ValueType,
    ...
    public:
        ...
        /// @brief Single value name info entry.
        using ValueNameInfo = demo1::message::EnumsFieldsCommon::F3Common::ValueNameInfo;
        
        /// @brief Type returned from @ref valueNamesMap() member function.
        /// @see @ref demo1::message::EnumsFieldsCommon::F3Common::ValueNamesMapInfo.
        using ValueNamesMapInfo = demo1::message::EnumsFieldsCommon::F3Common::ValueNamesMapInfo;
        
        /// @brief Retrieve name of the enum value.
        /// @see @ref demo1::message::EnumsFieldsCommon::F3Common::valueName().
        static const char* valueName(ValueType val)
        {
        ...
        /// @brief Retrieve map of enum value names.
        /// @see @ref demo1::message::EnumsFieldsCommon::F3Common::valueNamesMap().
        static ValueNamesMapInfo valueNamesMap()
        {
            return demo1::message::EnumsFieldsCommon::F3Common::valueNamesMap();
        }
    ...
    /// @see @ref demo1::message::EnumsFieldsCommon::F4Common::ValueType
    class F4 : public
        comms::field::EnumValue<
            demo1::field::FieldBase<>,
            demo1::message::EnumsFieldsCommon::F4Common::ValueType,
    ...
    public:
        ...
        /// @brief Single value name info entry.
        using ValueNameInfo = demo1::message::EnumsFieldsCommon::F4Common::ValueNameInfo;
        
        /// @brief Type returned from @ref valueNamesMap() member function.
        /// @see @ref demo1::message::EnumsFieldsCommon::F4Common::ValueNamesMapInfo.
        using ValueNamesMapInfo = demo1::message::EnumsFieldsCommon::F4Common::ValueNamesMapInfo;
        
        /// @brief Retrieve name of the enum value.
        /// @see @ref demo1::message::EnumsFieldsCommon::F4Common::valueName().
        static const char* valueName(ValueType val)
        {
        ...
        /// @brief Retrieve map of enum value names.
        /// @see @ref demo1::message::EnumsFieldsCommon::F4Common::valueNamesMap().
        static ValueNamesMapInfo valueNamesMap()
        {
            return demo1::message::EnumsFieldsCommon::F4Common::valueNamesMap();
        }

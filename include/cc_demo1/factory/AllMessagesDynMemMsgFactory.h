...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 0 /* 0x0 */: return MsgPtr(new cc_demo1::message::Ack<TInterface, TProtOptions>);
            case 1 /* 0x1 */: return MsgPtr(new cc_demo1::message::SimpleInts<TInterface, TProtOptions>);
            case 2 /* 0x2 */: return MsgPtr(new cc_demo1::message::ScaledInts<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new cc_demo1::message::Floats<TInterface, TProtOptions>);
            case 4 /* 0x4 */: return MsgPtr(new cc_demo1::message::Enums<TInterface, TProtOptions>);
            case 5 /* 0x5 */: return MsgPtr(new cc_demo1::message::Sets<TInterface, TProtOptions>);
            case 6 /* 0x6 */: return MsgPtr(new cc_demo1::message::Bitfields<TInterface, TProtOptions>);
            case 7 /* 0x7 */: return MsgPtr(new cc_demo1::message::Strings<TInterface, TProtOptions>);
            case 8 /* 0x8 */: return MsgPtr(new cc_demo1::message::Datas<TInterface, TProtOptions>);
            case 9 /* 0x9 */: return MsgPtr(new cc_demo1::message::Lists<TInterface, TProtOptions>);
            case 10 /* 0xa */: return MsgPtr(new cc_demo1::message::Optionals<TInterface, TProtOptions>);
            case 11 /* 0xb */: return MsgPtr(new cc_demo1::message::Variants<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 3 /* 0x3 */: return 1U;
            case 4 /* 0x4 */: return 1U;
            case 5 /* 0x5 */: return 1U;
            case 6 /* 0x6 */: return 1U;
            case 7 /* 0x7 */: return 1U;
            case 8 /* 0x8 */: return 1U;
            case 9 /* 0x9 */: return 1U;

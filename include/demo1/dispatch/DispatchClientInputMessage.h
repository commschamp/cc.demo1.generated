...
///     using MySomeOtherMessage = demo1::message::SomeOtherMessage<MyInterface, demo1::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in demo1/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<demo1::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<demo1::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo1::options::DefaultOptions.
/// @headerfile "demo1/dispatch/DispatchClientInputMessage.h"
...
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(demo1::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo1::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo1::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(demo1::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo1::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo1::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref demo1::options::DefaultOptions as template parameter.
/// @note Defined in "demo1/dispatch/DispatchClientInputMessage.h"
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<demo1::options::DefaultOptions>;

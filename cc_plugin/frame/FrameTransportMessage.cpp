...
struct SyncLayer
{
    ...
    {
        using Field = demo1::frame::FrameLayers<>::SyncMembers::Sync;
        return
...
struct SizeLayer
{
    ...
    {
        using Field = demo1::frame::FrameLayers<>::SizeMembers::Size;
        return
            cc::property::field::ForField<Field>()
                .name(Field::name())
                .displayOffset(2)
...
struct ChecksumLayer
{
    ...
    {
        using Field = demo1::frame::FrameLayers<>::ChecksumMembers::Checksum;
        return
            cc::property::field::ForField<Field>()
                .name(Field::name())
                .asMap();

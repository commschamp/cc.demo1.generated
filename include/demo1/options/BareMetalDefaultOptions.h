...
struct BareMetalDefaultOptions
{
    ...
    struct message
    {
        ...
        struct DatasFields
        {
            ...
            using F1 = comms::option::app::SequenceFixedSizeUseFixedSizeStorage;
            
            /// @brief Extra options for @ref
            ///     demo1::message::DatasFields::F2 field.
            using F2 = comms::option::app::FixedSizeStorage<DEFAULT_SEQ_FIXED_STORAGE_SIZE>;
            ...
            using F4 = comms::option::app::FixedSizeStorage<DEFAULT_SEQ_FIXED_STORAGE_SIZE>;
        ...
        struct ListsFields
        {
            ...
            struct F4Members
            {
                ...
                struct ElementMembers
                {
                    ...
                    ///     field.
                    using Mem2 = comms::option::app::FixedSizeStorage<DEFAULT_SEQ_FIXED_STORAGE_SIZE>;
        ...
        struct VariantsFields
        {
            ...
            struct Props1Members
            {
                ...
                struct PropertyMembers
                {
                    ...
                    struct Prop3Members
                    {
                        ...
                        ///     field.
                        using Val = comms::option::app::FixedSizeStorage<DEFAULT_SEQ_FIXED_STORAGE_SIZE>;
            ...
            ///     field.
            using Props2 = comms::option::app::FixedSizeStorage<DEFAULT_SEQ_FIXED_STORAGE_SIZE>;

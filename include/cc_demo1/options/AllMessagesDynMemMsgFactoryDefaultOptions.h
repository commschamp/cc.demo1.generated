...
#include "cc_demo1/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo1::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo1::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

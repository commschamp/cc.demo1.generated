...
struct FloatsFieldsCommon
{
    ...
    struct TimeoutCommon
    {
        ...
        {
            return static_cast<ValueType>(static_cast<ValueType>(0.000000));
        }
        ...
        {
            return static_cast<ValueType>(std::numeric_limits<ValueType>::quiet_NaN());
        }
    ...
    struct DistanceCommon
    {
        ...
        static constexpr ValueType valueInfinite()
        {
            return static_cast<ValueType>(std::numeric_limits<ValueType>::infinity());
        }

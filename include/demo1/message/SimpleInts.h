...
struct SimpleIntsFields
{
    ...
    public:
        ...
        using SpecialNameInfo = demo1::message::SimpleIntsFieldsCommon::F1Common::SpecialNameInfo;
        
        /// @brief Type returned from @ref specialNamesMap() member function.
        /// @details The @b first value of the pair is pointer to the map array,
        ///     The @b second value of the pair is the size of the array.
        using SpecialNamesMapInfo = demo1::message::SimpleIntsFieldsCommon::F1Common::SpecialNamesMapInfo;
        
        /// @brief Compile time detection of special values presence.
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F1Common::hasSpecials();
        }
        
        /// @brief Special value <b>"S1"</b>.
        /// @see @ref demo1::message::SimpleIntsFieldsCommon::F1Common::valueS1().
        static constexpr ValueType valueS1()
        {
            return demo1::message::SimpleIntsFieldsCommon::F1Common::valueS1();
        }
        ...
        {
            return demo1::message::SimpleIntsFieldsCommon::F1Common::specialNamesMap();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F2Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F3Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F4Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F5Common::hasSpecials();
        }
    ...
    public:
        ...
        /// @brief Single special value name info entry.
        using SpecialNameInfo = demo1::message::SimpleIntsFieldsCommon::F6Common::SpecialNameInfo;
        
        /// @brief Type returned from @ref specialNamesMap() member function.
        /// @details The @b first value of the pair is pointer to the map array,
        ///     The @b second value of the pair is the size of the array.
        using SpecialNamesMapInfo = demo1::message::SimpleIntsFieldsCommon::F6Common::SpecialNamesMapInfo;
        
        /// @brief Compile time detection of special values presence.
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F6Common::hasSpecials();
        }
        
        /// @brief Special value <b>"S1"</b>.
        /// @see @ref demo1::message::SimpleIntsFieldsCommon::F6Common::valueS1().
        static constexpr ValueType valueS1()
        {
            return demo1::message::SimpleIntsFieldsCommon::F6Common::valueS1();
        }
        ...
        static SpecialNamesMapInfo specialNamesMap()
        {
            return demo1::message::SimpleIntsFieldsCommon::F6Common::specialNamesMap();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F7Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F8Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F9Common::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo1::message::SimpleIntsFieldsCommon::F10Common::hasSpecials();
        }

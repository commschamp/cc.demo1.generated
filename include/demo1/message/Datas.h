...
struct DatasFields
{
    ...
    public:
        ...
        {
            return demo1::message::DatasFieldsCommon::F3LenCommon::hasSpecials();
        }
    ...
    struct F2Members
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo1::message::DatasFieldsCommon::F2MembersCommon::LengthCommon::hasSpecials();
            }
...
private:
    ...
    bool refresh_f3()
    {
        auto expectedLength = static_cast<std::size_t>(field_f3Len().getValue());
        auto realLength = field_f3().getValue().size();
        if (expectedLength == realLength) {
            return false;
        }

        using LenValueType = typename std::decay<decltype(field_f3Len().getValue())>::type;

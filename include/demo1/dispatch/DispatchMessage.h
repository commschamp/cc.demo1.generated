...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo1::options::DefaultOptions.
/// @headerfile "demo1/dispatch/DispatchMessage.h"
...
struct MsgDispatcher
{
    ...
    static auto dispatch(demo1::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(demo1::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return demo1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<demo1::options::DefaultOptions>;

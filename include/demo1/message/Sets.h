...
struct SetsFields
{
    ...
    public:
        ...
        /// @see @ref demo1::message::SetsFieldsCommon::F1Common::bitName().
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref demo1::message::SetsFieldsCommon::F2Common::bitName().
        static const char* bitName(BitIdx idx)
        {
            return
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref demo1::message::SetsFieldsCommon::F3Common::bitName().
        static const char* bitName(BitIdx idx)
        {
            return

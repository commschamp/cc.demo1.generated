...
#include "cc_demo1/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo1::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo1::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

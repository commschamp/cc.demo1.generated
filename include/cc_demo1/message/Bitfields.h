    ...
    struct F1Members
    {
        ...
        class Mem1 : public
            comms::field::IntValue<
                ...
                comms::option::def::FixedBitLength<3>
            >
        {
            using Base =
                comms::field::IntValue<
        ...
        public:
            ...
            {
                return cc_demo1::message::BitfieldsFieldsCommon::F1MembersCommon::Mem2Common::bitName(idx);
            }
...
class Bitfields : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<6 /* 0x6 */>,

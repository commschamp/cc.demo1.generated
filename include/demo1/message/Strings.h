...
struct StringsFields
{
    ...
    public:
        ...
        {
            return demo1::message::StringsFieldsCommon::F4LenCommon::hasSpecials();
        }
    ...
    struct F2Members
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo1::message::StringsFieldsCommon::F2MembersCommon::LengthCommon::hasSpecials();
            }
...
private:
    ...
    bool refresh_f4()
    {
        auto expectedLength = static_cast<std::size_t>(field_f4Len().getValue());
        auto realLength = field_f4().value().size();
        if (expectedLength == realLength) {
            return false;
        }

        using LenValueType = typename std::decay<decltype(field_f4Len().getValue())>::type;

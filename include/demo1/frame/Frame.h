...
#include "demo1/frame/FrameCommon.h"
...
struct FrameLayers
{
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return demo1::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::hasSpecials();
            }
            
            /// @brief Name of the field.
            static const char* name()
            {
                return demo1::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::name();
            }
    ...
    struct ChecksumMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo1::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::hasSpecials();
            }
            
            /// @brief Name of the field.
            static const char* name()
            {
                return demo1::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::name();
            }
    ...
    struct SyncMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo1::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::hasSpecials();
            }
            
            /// @brief Name of the field.
            static const char* name()
            {
                return demo1::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::name();
            }
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(43981L);
                return true;
            }
        };
